// package main // helps to compile go code

// import (
// 	"fmt"
// ) // improting formate library

// func main() {
// 	fmt.Print("Hello From Go")
// }
// // command to initialise the app
// // go mod init appname
package main
...
func main() {
	...
	backBtn := widget.NewButton("Back", func() {
		if len(output) > 0 {
			output = output[:len(output)-1] // ek length kum ki substring
	...
	equalBtn := widget.NewButton("=", func() {
		...
		if err == nil {
			...
			if err == nil {
				// to convert result which is an interface{} to string
				ans := fmt.Sprintf("%v", result)
